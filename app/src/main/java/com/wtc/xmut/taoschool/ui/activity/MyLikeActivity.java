...
import com.wtc.xmut.taoschool.adpater.MyLikeAdapter;
...
public class MyLikeActivity extends AppCompatActivity {
    ...
    private void initData() {
        xutilsUtils.getCache(ServerApi.GETSHOPBYLIKENAME + username, null, false, 60 * 6000, new XutilsUtils.XCallBack() {
            @Override
    ...
    private void parseJson(String result) {
        ...
        adapter = new MyLikeAdapter(getApplicationContext(),shopList,this);
